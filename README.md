...
<!-- 🟩 = strong / included, ⬜ = weak / missing / paid. bgcolor+style show as cell backgrounds where the renderer allows HTML styles (GitHub strips them, so the markers carry the meaning there). -->
🟩 strong / included · ⬜ weak / missing / paid.
<table>
<thead>
